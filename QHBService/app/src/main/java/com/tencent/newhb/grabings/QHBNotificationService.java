...
//        }
    ...
    public void onListenerConnected() {
        ...
        service = this;
        //发送广播，已经连接上了
        Intent intent = new Intent(getString(R.string.app_package_name) + Config.ACTION_NOTIFY_LISTENER_SERVICE_CONNECT);
    ...
    public void onDestroy() {
        ...
        service = null;
        //发送广播，已经连接上了
        Intent intent = new Intent(getString(R.string.app_package_name) + Config.ACTION_NOTIFY_LISTENER_SERVICE_DISCONNECT);
        sendBroadcast(intent);
    }
